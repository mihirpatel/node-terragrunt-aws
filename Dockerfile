...
RUN terraenv terraform install ${TERRAFORM} && terraenv terraform install 0.13.4 && terraenv terraform use ${TERRAFORM} && terraform --version
RUN terraenv terragrunt install ${TERRAGRUNT} && terraenv terragrunt install 0.25.2 && terraenv terragrunt use ${TERRAGRUNT} && terragrunt --version
